...
def diff_item(
    faker: faker_package.Faker,
) -> typing.Callable[[typing.Optional[str]], git.Diff]:
    ...
    return typing.cast(
        typing.Callable[[typing.Optional[str]], git.Diff], DiffItem
    )


def test_calculate_file_changes_return_file_changes(
    diff_item: typing.Callable[[typing.Optional[str]], git.Diff],
    mocker: pytest_mock.MockerFixture,
) -> None:
